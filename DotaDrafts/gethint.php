...
// Team full, show advantage
if(count($team1->team) == 5 && count($team2->team) == 5){
    $t1_advantage = $team1->getTotalAdvantage($team1, $team2);
    $t2_advantage = $team2->getTotalAdvantage($team2, $team1);

    echo "team1/" . $t1_advantage . "/team2/" . $t2_advantage;
} else{
